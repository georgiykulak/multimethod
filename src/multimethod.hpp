#ifndef MULTIMETHOD_MULTIMETHOD_HPP
#define MULTIMETHOD_MULTIMETHOD_HPP
...
template< class Base, class Result, bool Commutative >
using Multimethod2 = multimethod::Multimethod< Base, Result, Commutative >;

#endif // MULTIMETHOD_MULTIMETHOD_HPP //
